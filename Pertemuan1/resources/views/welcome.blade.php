...
<body class="grid">
  <div class="ktp-wrapper rounded-xl place-self-center px-10 py-3 border-2">
    <div class="header-wrapper grid place-items-center">
      ...
      <div class="province">KABUPATEN PASURUAN</div>
    </div>
    <div class="body-wrapper mt-2 flex gap-[2rem]">
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td class="ps-1 font-semibold text-lg">3514022402030001</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Nama <span>:</span>
              </td>
              <td class="ps-1 text-sm uppercase">MUKHAMAD DIKI FEBRIAN</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Tempat/Tgl Lahir <span>:</span>
              </td>
              <td class="ps-1 text-sm">PASURUAN, 24-02-2003</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
            ...
            <tr>
              ...
              <td class="ps-1 text-sm">WONOSARI TENGAH</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
            ...
            <tr>
              ...
              <td class="ps-1 text-sm">WONOSARI</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                <span class="ms-9">KECAMATAN</span> <span>:</span>
              </td>
              <td class="ps-1 text-sm">TUTUR</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Agama <span>:</span>
      ...
      <div class="left-content grid">
        <div class="image-wrapper w-full">
          <img src="{{asset('img/Pas foto.jpg')}}" class=" object-cover h-full w-40 rounded" />
        </div>
        <div class="created-at text-center">
          <div class="region text-sm font-semibold mt-1">PASURUAN</div>
          <div class="region text-sm">01-10-2021</div>
        </div>
      </div>
    </div>
